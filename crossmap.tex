...
\begin{abstract} % abstract
  ...
  Large biological checklists require verification to remove typographical
  mistakes, and erroneous names, to update to currently used names for outdated
  ones. Usually such lists are stored in a some sort of a spreadsheet, and
  the curator of the list are interested in comparing it with either a
  nomenclatural source like Index Fungorum, or IPNI, or with a taxonomical
  source like Catalogue of Life. Comparing such lists by hand is very tedious
  and error-prone.
  \parttitle{Results}
  We created a convenience tool gn-crossmap which allows to intelligently match
  names from such list and write restuls back into a spreadsheet. The tool is
  ...
  greatly simplifies mapping of names from a list to an authoritative source of
  names.
\end{abstract}
...
\begin{itemize}
  ...
  \item Problems -- hard to check agains resources as names are spelled
    differently
...
\begin{itemize}
  ...
  \item requirements
    \begin{itemize}
      ...
      \item able to map unknown fields to known fields
  ...
  \item current problems and future work
    \begin{itemize}
      ...
      \item intelligent authorshipo type recognition
...
\begin{itemize}
  ...
  \item gn-match solves existing problems...
  \item gn-match  future work
    \begin{itemize}
